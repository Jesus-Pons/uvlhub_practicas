...
class NotepadBehavior(TaskSet):
    ...
    def create_notepad(self):
        response = self.client.post("/notepad/create",
                                    json={"title": "Notepad generado por Locust", "body": "Contenido de prueba"})
    ...
    def edit_notepad(self):
        response = self.client.post("/notepad/edit/1",
                                    json={"title": "Notepad editado por Locust", "body": "Contenido editado de prueba"})
        if response.status_code == 200:
